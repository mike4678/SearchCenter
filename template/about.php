	...
	<div class="col-lg-4 col-md-6 col-xs-12">
    	<div class="box-content">
              <table class="table">
					...
					<tr><td align="right">源码下载：</td><td><a href="http://tool.csource.com.cn/SearchCenter.zip" target="_blank">点击下载</a>(<a href="https://github.com/mike4678/SearchCenter" target="_blank">GitHub</a>)(<a href="https://gitee.com/marcocat/SearchCenter" target="_blank">Gitee</a>)</td><td align="right">客户端下载：</td><td><a href="http://tool.csource.com.cn/QueryClient.zip" target="_blank">点击下载</a></td></tr>
                </table>
            </div>
        </div>
		            </div>
